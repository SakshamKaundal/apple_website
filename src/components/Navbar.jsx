  ...
  return (
    <header className="w-full py-5 sm:px-10 px-5 flex justify-between
        ...
        <nav className='flex w-full screen-max-width'>
            ...
            <div className='flex flex-1 justify-center max-sm:hidden'>{['Phones','Macbooks','Tablets'].map((nav)=>(
            ...
            max-sm:justify-end max-sm:flex-1'>
                <img src={searchImg} ult="Search" width={18} height={18}/>
                <img src={bagImg} ult="bag" width={18} height={18}/>
            </div>
